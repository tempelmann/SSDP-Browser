...
@interface SSDPDiscovery : NSObject
	...
	- (void) discoverServiceForDuration:(NSTimeInterval)duration /*10*/ searchTarget:(NSString*)searchTarget /*"ssdp:all"*/ port:(UInt16)port /*1900*/ onInterfaces:(NSArray<NSString*>*)onInterfaces specificAddress:(NSString*__nullable)specificAddress;
	- (void) stop;
